...
public class FixedSizeSlidingStatistics implements SlidingStatisticsInterface
{
    private final static Logger logger = LoggerFactory.getLogger(FixedSizeSlidingStatistics.class);
    ...
    public FixedSizeSlidingStatistics(int numberOfSamples)
    {
    ...
    addTransaction(Transaction transaction)
    {
        ...
        {
            if(statistics.canThisBeAppliedToStatistics(transaction))
            {
