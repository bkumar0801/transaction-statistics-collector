...
public class StatisticsCalculator
{
    ...
    public boolean canThisBeAppliedToStatistics(Transaction transaction) {
    ...
    {
        if(canThisBeAppliedToStatistics(transaction))
        {
            ...
            logger.debug("Transaction {} can not be applied {}.",transaction,unixEpoch);
        }
    }
