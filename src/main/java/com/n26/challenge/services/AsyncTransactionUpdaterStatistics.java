...
public class AsyncTransactionUpdaterStatistics extends SchedulableSingleWorker
        implements SlidingStatisticsInterface
{
    private final static Logger logger = LoggerFactory
            .getLogger(AsyncTransactionUpdaterStatistics.class);

    private final SlidingStatisticsInterface delegate;
    private final BlockingQueue<Transaction> transactions;

    public AsyncTransactionUpdaterStatistics(SlidingStatisticsInterface delegate,
